...
const inferAlternatives = () => [
  {
    name: "About Markify",
    href: "/about",
    summary: "Learn what Markify does and how it fits into your workflow.",
  },
  {
    name: "Pricing",
    href: "/pricing",
    summary: "Compare plans and choose the right tier for your needs.",
  },
  {
    name: "Blog",
    href: "/blog",
    summary: "Read practical guides, updates, and workflow tips.",
  },
];
...
export const getBlogContentModel = (post) => {
  ...
  const payload = {
    ...
    reviewedBy: override.reviewedBy || "Mohd Kaif",
    ...
    uniqueValue:
      override.uniqueValue || [
        ...
        "Context-aware internal links to product pages and related articles",
