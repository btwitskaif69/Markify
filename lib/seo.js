export const SITE_CONFIG = {
  ...
  defaultLocale: "en-US",
  locales: ["en-US"],
  defaultTitle: "The Only Bookmark Manager You'll Ever Need | Markify",
  defaultDescription:
  ...
  socialProfiles: [
    "https://twitter.com/btwitskaif69",
  ],
    ...
    review: [
      {
        ...
        reviewBody: "Markify has completely transformed how I organize my links and research.",
      },
    ],
  };
  if (offers) {
...
export const buildHowToSchema = ({
  ...
  const normalizedSteps = steps
    .map((step, index) => {
      ...
      return {
        "@type": "HowToStep",
        position: index + 1,
        name: step.name || step.text || `Step ${index + 1}`,
  ...
  return {
    ...
    ...(Array.isArray(supply) && supply.length
      ...
      : {}),
    ...(Array.isArray(tool) && tool.length
