    ...
    <div className="w-full min-h-screen bg-black flex items-center justify-center">
      ...
      <div
        ...
        <div
          ...
          <p className="text-lg font-medium text-center max-w-xl px-4" style={{ color: colors.textSecondary }}>
            Smart Collections, Lightning-Fast Global Search, and Privacy-First Bookmarking Manager.
          </p>
