...
export const AnimationStyles = ({ variant, start, url }) => {
...
// Add PropTypes for runtime type checking in JavaScript
AnimationStyles.propTypes = {
  variant: PropTypes.oneOf(['circle', 'circle-blur', 'polygon', 'gif']).isRequired,
  start: PropTypes.oneOf(['top-left', 'top-right', 'bottom-left', 'bottom-right', 'center']).isRequired,
