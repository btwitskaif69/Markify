 ...
 */
export const bulkDeleteBookmarks = async (req, res) => {
  try {
    const { ids } = req.body;
 ...
 */
export const syncLocalBookmarks = async (req, res) => {
  try {
 ...
 */
export const fetchBookmarkPreview = async (req, res) => {
  try {
    const { bookmarkId } = req.params;
...
export const toggleShareBookmark = async (req, res) => {
  try {
    ...
    // Toggle shareId
    const newShareId = bookmark.shareId ? null : randomUUID();
 ...
 */
export const getSharedBookmark = async (req, res) => {
  try {
