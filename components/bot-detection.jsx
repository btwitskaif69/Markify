  ...
  return (
    <div
      ...
      <div className="absolute top-6 left-6 z-10">
        <h3 className="text-lg md:text-xl font-bold text-foreground">{cardTitle}</h3>
      </div>
      <div
        className="absolute left-1/2 h-full min-w-[300px] max-w-[300px] -translate-x-1/2">
        <div className="relative h-[80%] w-full">
          ...
          <div
            className="absolute bottom-2 left-1/2 h-28 w-28 -translate-x-1/2 rounded-full border border-border bg-background" />
        </div>
      </div>
...
const ContainerMask = () => {
  return (
    <>
      <div
        className="absolute left-1/2 top-[48px] h-full w-[100%] -translate-x-1/2 rounded-full border-t border-dashed border-border/80" />
      <div
        className="absolute left-1/2 top-[100px] h-full w-[90%] -translate-x-1/2 rounded-full border-t border-dashed border-border/80" />
      <div
        className="absolute left-1/2 top-[152px] h-full w-[80%] -translate-x-1/2 rounded-full border-t border-dashed border-border/80" />
      <div
        className="absolute left-1/2 top-[204px] h-full w-[65%] -translate-x-1/2 rounded-full border-t border-dashed border-border/80" />
    </>
  );
};
