        ...
        <CardContent>
          <form onSubmit={handleSubmit}>
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                <div className="flex items-center">
                  ...
                  <Link href="/forgot-password" className="ml-auto inline-block text-sm underline-offset-4 hover:underline text-muted-foreground hover:text-primary">
                ...
                <div className="relative">
                  ...
                  {formData.password.length > 0 && (
                    <div
                      ...
                      className="absolute top-0 right-0 h-full px-3 flex items-center cursor-pointer select-none text-muted-foreground hover:text-foreground"
                    >
                      {showPassword ? (
              ...
              <div className="flex flex-col gap-3 pt-2">
                ...
                <div className="relative">
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="w-5 h-5 mr-2 fill-current">
            ...
            <div className="mt-4 text-center text-sm text-muted-foreground">
              ...
              <Link href="/signup" className="underline underline-offset-4 hover:text-primary text-foreground">
                Sign up
              </Link>
            </div>
          </form>
