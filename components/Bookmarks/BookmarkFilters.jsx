...
export default function BookmarkFilters({
  ...
  return (
    <>
      ...
      {/* Filters */}
      <div className="flex flex-wrap items-center gap-x-2 gap-y-4 mb-6">
        {/* Search */}
        <Button
          variant="outline"
          className="basis-full lg:basis-0 lg:flex-1 justify-between bg-background! pr-1!"
          onClick={onOpenCmdK}
        >
        ...
        <Select value={selectedCategory} onValueChange={setSelectedCategory}>
          <SelectTrigger className="flex-1 min-w-0 lg:flex-initial lg:w-[160px] bg-background!">
