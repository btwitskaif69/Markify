...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      // dark styles
      "transform-gpu dark:bg-background dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#f54900_inset]",
      className
    )}
    {...props}>
    <div>{background}</div>
    <div className="p-4">
      <div
        ...
        <Icon
          className="h-12 w-12 origin-left transform-gpu text-primary transition-all duration-300 ease-in-out group-hover:scale-75" />
